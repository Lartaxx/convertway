...
fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activer pour trier la colonne de manière ascendante",sSortDescending:": activer pour trier la colonne en descendant"},oPaginate:{sFirst:"Premier",sLast:"Dernier",
sNext:"Suivant",sPrevious:"Précédent"},sEmptyTable:"Aucune donnée disponible dans le tableau",sInfo:"Affichage de _START_ à _END_ sur _TOTAL_ données",sInfoEmpty:"Affichage de 0 à 0 de 0 données",sInfoFiltered:"(filtré à partir de _MAX_ données totales)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Afficher _MENU_ données",sLoadingRecords:"Chargement...",sProcessing:"En cours...",sSearch:"Rechercher :",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucun enregistrement correspondant trouvé"},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
